...
ball_images = [
    pygame.image.load(os.path.join(image_path, "balloon1.jpg")),
    pygame.image.load(os.path.join(image_path, "balloon2.jpg")),
    pygame.image.load(os.path.join(image_path, "balloon3.jpg")),
