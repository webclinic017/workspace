...
# pyautogui.click(1488, 18, duration=1)   # 1초 동안 (1488, 18) 좌표를 이동 후 마우스 클릭
# pyautogui.click()
# pyautogui.mouseDown()
# pyautogui.mouseUp()
